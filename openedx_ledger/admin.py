...
class AdjustmentAdmin(SimpleHistoryAdmin):
    ...
    def get_fields(self, request, obj=None):
        ...
        if not obj:
            ...
            # When we're reading/editing an existing adjustment, show all fields EXCEPT for the fiels exclusively used
...
class DepositAdmin(SimpleHistoryAdmin):
    ...
    def get_fields(self, request, obj=None):
        ...
        """
        # When we're adding a new deposti, use default fields
        if not obj:
            return [
                'ledger',
                'quantity_usd_input',
