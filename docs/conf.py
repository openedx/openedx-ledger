...
exclude_patterns = [
    ...
    'Thumbs.db',
    '.DS_Store',
    # This file is intended as a guide for developers browsing the source tree, not to be rendered into the output docs.
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/openedx-ledger",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Records transactions against a ledger, denominated in units of value.',
     'Miscellaneous'),
]
